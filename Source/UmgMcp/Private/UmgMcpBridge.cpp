#include "UmgMcpBridge.h"
#include "UmgMcpConfig.h"
...
void UUmgMcpBridge::StartServer()
{
    if (bIsRunning)
    {
        UE_LOG(LogTemp, Warning, TEXT("UmgMcpBridge: Server is already running"));
        return;
    }
    ...
    if (!SocketSubsystem)
    {
        UE_LOG(LogTemp, Error, TEXT("UmgMcpBridge: Failed to get socket subsystem"));
        return;
    }
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("UmgMcpBridge: Failed to create listener socket"));
        return;
    }
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("UmgMcpBridge: Failed to bind listener socket to %s:%d"), *ServerAddress.ToString(), Port);
        return;
    }
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("UmgMcpBridge: Failed to start listening"));
        return;
    }

    ListenerSocket = NewListenerSocket;
    bIsRunning = true;
    UE_LOG(LogTemp, Display, TEXT("UmgMcpBridge: Server started on %s:%d"), *ServerAddress.ToString(), Port);
    ...
    if (!ServerThread)
    {
        UE_LOG(LogTemp, Error, TEXT("UmgMcpBridge: Failed to create server thread"));
        StopServer();
        return;
    }
}
...
void UUmgMcpBridge::StopServer()
{
    ...
    UE_LOG(LogTemp, Display, TEXT("UmgMcpBridge: Server stopped"));
}

// Execute a command received from a client
FString UUmgMcpBridge::ExecuteCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
    UE_LOG(LogTemp, Display, TEXT("UmgMcpBridge: Executing command: %s"), *CommandType);
