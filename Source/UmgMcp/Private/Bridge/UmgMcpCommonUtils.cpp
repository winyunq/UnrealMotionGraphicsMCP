...
// JSON Utilities
TSharedPtr<FJsonObject> FUmgMcpCommonUtils::CreateErrorResponse(const FString& Message)
{
...
TSharedPtr<FJsonObject> FUmgMcpCommonUtils::CreateSuccessResponse(const TSharedPtr<FJsonObject>& Data)
{
    TSharedPtr<FJsonObject> ResponseObject = MakeShared<FJsonObject>();
    ...
    if (Data.IsValid())
    {
        ...
        {
            ResponseObject->SetField(Field.Key.ToView(), Field.Value);
        }
    }
...
void FUmgMcpCommonUtils::GetIntArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<int32>& OutArray)
{
    OutArray.Reset();
...
void FUmgMcpCommonUtils::GetFloatArrayFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName, TArray<float>& OutArray)
{
    OutArray.Reset();
...
FVector2D FUmgMcpCommonUtils::GetVector2DFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FVector FUmgMcpCommonUtils::GetVectorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
FRotator FUmgMcpCommonUtils::GetRotatorFromJson(const TSharedPtr<FJsonObject>& JsonObject, const FString& FieldName)
{
...
// Blueprint Utilities
UBlueprint* FUmgMcpCommonUtils::FindBlueprint(const FString& BlueprintName)
{
...
UEdGraph* FUmgMcpCommonUtils::FindOrCreateEventGraph(UBlueprint* Blueprint)
{
    if (!Blueprint)
    {
        return nullptr;
...
UK2Node_Event* FUmgMcpCommonUtils::CreateEventNode(UEdGraph* Graph, const FString& EventName, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
UK2Node_CallFunction* FUmgMcpCommonUtils::CreateFunctionCallNode(UEdGraph* Graph, UFunction* Function, const FVector2D& Position)
{
    if (!Graph || !Function)
    {
        return nullptr;
...
UK2Node_VariableGet* FUmgMcpCommonUtils::CreateVariableGetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
    if (!Graph || !Blueprint)
    {
        return nullptr;
...
UK2Node_VariableSet* FUmgMcpCommonUtils::CreateVariableSetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FVector2D& Position)
{
    if (!Graph || !Blueprint)
    {
        return nullptr;
...
UK2Node_InputAction* FUmgMcpCommonUtils::CreateInputActionNode(UEdGraph* Graph, const FString& ActionName, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
UK2Node_Self* FUmgMcpCommonUtils::CreateSelfReferenceNode(UEdGraph* Graph, const FVector2D& Position)
{
    if (!Graph)
    {
        return nullptr;
...
bool FUmgMcpCommonUtils::ConnectGraphNodes(UEdGraph* Graph, UEdGraphNode* SourceNode, const FString& SourcePinName, 
...
UEdGraphPin* FUmgMcpCommonUtils::FindPin(UEdGraphNode* Node, const FString& PinName, EEdGraphPinDirection Direction)
{
    if (!Node)
    {
        return nullptr;
...
// Actor utilities
TSharedPtr<FJsonValue> FUmgMcpCommonUtils::ActorToJson(AActor* Actor)
{
    if (!Actor)
    {
...
TSharedPtr<FJsonObject> FUmgMcpCommonUtils::ActorToJsonObject(AActor* Actor, bool bDetailed)
{
    if (!Actor)
    {
        return nullptr;
...
UK2Node_Event* FUmgMcpCommonUtils::FindExistingEventNode(UEdGraph* Graph, const FString& EventName)
{
    if (!Graph)
    {
        return nullptr;
...
bool FUmgMcpCommonUtils::SetObjectProperty(UObject* Object, const FString& PropertyName, 
