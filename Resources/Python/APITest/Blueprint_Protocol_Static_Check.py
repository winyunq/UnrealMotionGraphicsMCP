...
def main() -> None:
    ...
    support_tools = {
        ...
        "set_target_blueprint_asset",
        "get_target_blueprint_asset",
        "set_target_widget",
        "get_target_widget",
        "save_asset",
    }
    ...
    require_text("Document/BlueprintBluecodeProtocol.md", "默认 semantic 读取不返回 hints")
    ...
    require_text("Document/BlueprintBluecodeProtocol.md", "`base_revision`、`source_map`")
    require_text("Document/BlueprintBluecodeProtocol.md", "LCS")
    require_text("Document/BlueprintBluecodeProtocol.md", "右锚点")
    require_text("Document/BlueprintBluecodeProtocol.md", "dry_run=true")
    require_text("Document/BlueprintBluecodeProtocol.md", "graph_revision_conflict")
    ...
    require_text("Resources/Python/UmgMcpServer.py", "base_revision")
    require_text("Resources/Python/UmgMcpServer.py", "source_map")
    require_text("Resources/Python/UmgMcpServer.py", "dry_run")
    require_text("Resources/Python/UmgMcpServer.py", 'mode: str = "union"')
    ...
    require_text("Resources/Python/UmgMcpSkills.py", "base_revision")
    require_text("Resources/Python/UmgMcpSkills.py", "source_map")
    require_text("Resources/Python/UmgMcpSkills.py", "dry_run")
    ...
    require_text("Resources/ToolModes/Blueprint.json", "注意力压缩")
    require_text("Resources/ToolModes/Blueprint.json", "base_revision")
    require_text("Resources/ToolModes/Blueprint.json", "source_map")
    require_text("Resources/ToolModes/Blueprint.json", "dry_run=true")
    ...
    require_text("Resources/prompts.json", "attention-compressed semantic BlueCode")
    require_text("Resources/prompts.json", "base_revision")
    require_text("Resources/prompts.json", "source_map")
    require_text("Resources/prompts.json", "dry_run=true")
    require_text("Resources/prompts.json", "LCS semantic alignment")
    ...
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "roundtrip_usage")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "MakeBluecodeGraphRevision")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "Semantic read order must be layout-independent")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "graph_revision_conflict")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "SetObjectField(TEXT(\"source_map\")")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "bRoundtripDetail")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "insertBeforeNodeId")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "auto_connect_would_replace_edge")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "RollbackCreatedNodes")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "ExportNodesToText")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "ImportNodesFromText")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "rollback_verified")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "bShouldMarkBlueprintModified")
    require_text("Source/UmgMcp/Private/Blueprint/UmgBlueprintFunctionSubsystem.cpp", "SetDirtyFlag(bPackageWasDirty)")
    require_text("Source/UmgMcp/Private/Blueprint/Bluecode/BluecodeMergePlanner.cpp", "PlanUnion")
    require_text("Source/UmgMcp/Private/Blueprint/Bluecode/BluecodeMergePlanner.cpp", "InsertBefore")
    require_text("Source/UmgMcp/Private/Blueprint/Bluecode/BluecodeSyntax.cpp", "FindTopLevelAssignmentOperator")
    require_text("Source/UmgMcp/Private/Tests/BluecodeMergePlannerTest.cpp", "NodeThree")
    require_text("Source/UmgMcp/Private/Tests/BluecodeMergePlannerTest.cpp", "Append Tool Result to Memory")
    ...
    fab_http_client = "Source/UmgMcp/Private/FabServer/FabServerHttpClient.cpp"
    if (ROOT / fab_http_client).is_file():
        require_text(fab_http_client, "ToolName == TEXT(\"bluecode_search_nodes\")")
        require_text(fab_http_client, "ToolName == TEXT(\"bluecode_connect\")")
        require_text(fab_http_client, "FinalArgs->SetStringField(TEXT(\"subAction\"), TEXT(\"bluecode_read_function\"))")

    fab_schema_builder = "Source/UmgMcp/Private/FabServer/Tools/UmgMcpToolSchemaBuilder.cpp"
    if (ROOT / fab_schema_builder).is_file():
        require_text(fab_schema_builder, "Tools.Add(TEXT(\"bluecode_search_nodes\")")
        require_text(fab_schema_builder, "Tools.Add(TEXT(\"bluecode_connect\")")
        require_text(fab_schema_builder, "include_connections")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"context_sensitive\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"exact\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"anchor\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"member_classes\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"action_handles\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"action_hints_by_line\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"expression_hints\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"node_aliases\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"aliases\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"node_properties\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"base_revision\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"source_map\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"dry_run\")")
        require_text(fab_schema_builder, "AddOptionalParam(T, TEXT(\"connects\")")
        require_text(fab_schema_builder, "kind node/variable/connection")
        require_text(fab_schema_builder, "signature")
